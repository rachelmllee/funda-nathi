...
class ChatMessagesControllerTest < ActionController::TestCase
  ...
  test "should create chat_message" do
    assert_difference('ChatMessage.count') do
      post :create, chat_message: { body: @chat_message.body, chat_id: @chat_message.chat_id, creator_id: @chat_message.creator_id, is_read: @chat_message.is_read }
    end
  ...
  test "should update chat_message" do
    patch :update, id: @chat_message, chat_message: { body: @chat_message.body, chat_id: @chat_message.chat_id, creator_id: @chat_message.creator_id, is_read: @chat_message.is_read }
    assert_redirected_to chat_message_path(assigns(:chat_message))
  end
